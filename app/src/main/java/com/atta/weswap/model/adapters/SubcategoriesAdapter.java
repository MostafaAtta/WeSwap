...
import com.atta.weswap.ui.SubcategoriesFragmentDirections;
...
public class SubcategoriesAdapter extends RecyclerView.Adapter<SubcategoriesAdapter.MyViewHolder> {
    ...
    public SubcategoriesAdapter(ArrayList<Subcategory> data, Context context, Activity activity) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            Navigation.findNavController(activity, R.id.nav_host_fragment).navigate(SubcategoriesFragmentDirections.actionSubCategoriesFragmentToAdsFragment(id));
